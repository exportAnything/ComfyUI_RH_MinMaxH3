...
from the source archive supplied for this integration. The reference snapshot
used for the native H3 implementation is:

- branch: `codex/minimax-h3-native-upstream`
- revision: `45b71b350`
