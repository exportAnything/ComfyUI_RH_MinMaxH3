...
_H3_COMPONENT_EXTERNAL_PATH_FIELDS = MappingProxyType(
    {
        ...
        "text_encoder": ("text_encoder_weights_path",),
        "vae": ("video_vae_weights_path", "audio_vae_weights_path"),
    }
)
...
def validate_component_for_task(
    ...
    *,
    ...
    if is_v2:
        ...
        for external_field in _H3_COMPONENT_EXTERNAL_PATH_FIELDS[component_kind]:
            external_value = component.get(external_field)
            ...
            clean[external_field] = str(resolved_external)
