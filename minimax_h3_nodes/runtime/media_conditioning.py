...
def resolve_reference_image_shape(*, width: int | float, height: int | float) -> dict[str, Any]:
    """Resolve a Ref2VA image independently at a 2048px short edge."""
